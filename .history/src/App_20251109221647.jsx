...
function App() {
  ...
  const [isDetailsViewActive, setIsDetailsViewActive] = useState(false); // <-- RESTORED: NEW STATE
  ...
  // RESTORED: HANDLER TO UPDATE DETAILS VIEW STATE
  ...
  const currentView = view === 'catalog' ? (
    <BookList 
      ...
      onDetailsViewChange={handleDetailsViewChange} // <-- RESTORED: NEW PROP
    />
  ) : (
    <LoanManager 
      books={books} 
